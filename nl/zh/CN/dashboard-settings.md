...
## SSH 密钥
Scylla 服务通过 SSH 门户网站进行供应，以支持 nodetool 对该服务进行管理。添加公用密钥和名称以获取对 SSH 门户网站的访问权。

![SSH 密钥](./images/scylla-portal-ssh-show.png "“SSH 密钥”字段")

有关 nodetool 如何使用 scylla 服务的信息，请参阅[使用 Nodetool](./scylla-nodetool.html)。
